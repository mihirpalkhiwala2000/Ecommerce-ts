...
var displayProduct = function (_a) {
    var _b = _a.limit, limit = _b === void 0 ? "5" : _b, _c = _a.pageNo, pageNo = _c === void 0 ? "1" : _c, sortBy = _a.sortBy, available = _a.available;
    return __awaiter(void 0, void 0, void 0, function () {
        var sort, query, skip, parts, products;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    query = {};
                    if (available) {
                        query = __assign(__assign({}, query), { available: available });
                    }
                    skip = 0;
                    if (sortBy) {
                        parts = void 0;
                    ...
                    return [4 /*yield*/, products_model_1.default.find(query, null, {
...
var displayMyProduct = function (_a, userId) {
    var _b = _a.limit, limit = _b === void 0 ? "5" : _b, _c = _a.pageNo, pageNo = _c === void 0 ? "1" : _c, sortBy = _a.sortBy, available = _a.available;
    return __awaiter(void 0, void 0, void 0, function () {
        var sort, query, skip, parts, products;
        return __generator(this, function (_d) {
...
var deleteProduct = function (id, user_Id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, products_model_1.default.findOneAndDelete({
                    _id: id,
                    owner: user_Id,
                })];
            case 1:
