...
var badRequest = errorMsgs.badRequest, serverError = errorMsgs.serverError, notFound = errorMsgs.notFound, noProductError = errorMsgs.noProductError;
...
productRouter.post("", auth_1.adminAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, reqBody, owner, product, e_1;
...
productRouter.post("/:id", auth_1.auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, quantity, _id, product, e_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                _id = req.params.id;
                return [4 /*yield*/, (0, products_controller_1.addToCart)(_id, user, quantity)];
            case 1:
                product = _a.sent();
                res.status(createdC).send({ data: product, message: success });
                return [3 /*break*/, 3];
...
productRouter.get("/viewcart", auth_1.auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, cartproducts, productsArray, length_1, totalQuant, i, e_5;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                user = req.body.user;
                return [4 /*yield*/, (0, products_controller_1.viewCart)(user._id)];
            case 1:
...
productRouter.delete("/deleteproduct/:id", auth_1.adminAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                e_6 = _a.sent();
                console.log("🚀 ~ file: products-router.ts:101 ~ productRouter.delete ~ e:", e_6);
                res.status(serverErrorC).send(serverError);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
...
productRouter.delete("/deleteproductfromcart/:id", auth_1.auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, product, e_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                user = req.body.user;
                return [4 /*yield*/, (0, products_controller_1.deleteProductFromCart)(req.params.id, user._id)];
            case 1:
                product = _a.sent();
                if (!product) {
                    return [2 /*return*/, res.status(notFoundC).send(noProductError)];
